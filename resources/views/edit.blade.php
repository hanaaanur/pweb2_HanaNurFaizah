                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="/organisasi/{{$data->id}}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="mb-3">
                                    <label for="id_organisasi" class="form-label">ID Organisasi</label>
                                    <input type="text" class="form-control" id="id_organisasi" name="id_organisasi" value="{{$data->id_organisasi}}">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukan Nama Organisasi atau Ekstrakurikuler" value="{{$data->nama}}">
                                </div>
                                <div class="mb-3">
                                    <label for="periode" class="form-label">Periode</label>
                                    <input type="text" class="form-control" id="periode" name="periode" placeholder="Masukan Tahun Periode" value="{{$data->periode}}">
                                </div>
                                <div class="mb-3">
                                    <label for="ketua" class="form-label">Ketua</label>
                                    <input type="text" class="form-control" id="ketua" name="ketua" placeholder="Masukan Nama Ketua" value="{{$data->ketua}}">
                                </div>
                                <div class="mb-3">
                                    <label for="nis" class="form-label">NIS</label>
                                    <input type="text" class="form-control" id="nis" name="nis" placeholder="Masukan NIS Ketua" value="{{$data->nis}}">
                                </div>
                                <div class="mb-3">
                                    <label for="pembina" class="form-label">Pembina</label>
                                    <input type="text" class="form-control" id="pembina" name="pembina" placeholder="Masukan Nama Pembina" value="{{$data->pembina}}">
                                </div>
                                <div class="mb-3">
                                    <label for="anggaran" class="form-label">Total Anggaran</label>
                                    <input type="text" class="form-control" id="anggaran" name="anggaran" placeholder="Masukan Total Anggaran" value="{{$data->anggaran}}">
                                </div>
