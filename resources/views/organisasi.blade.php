        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <!-- <a href="{{url('/edit')}}" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Edit</a> -->
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Data Organisasi dan Ekstrakurikuler</h6>
                            <div>
                            <a href="/form" class="btn btn-primary m-2">Tambah</a>
                            </div>
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach ($data as $org)
                                        <tr>
                                            <th scope="row">{{$org->id_organisasi}}</th>
                                            <td>{{$org->jenis}}</td>
                                            <td>{{$org->nama}}</td>
                                            <td>{{$org->periode}}</td>
                                            <td>{{$org->ketua}}</td>
                                            ...
                                            <td>{{$org->anggaran}}</td>
                                            <th>
                                            <!-- <button href="/organisasi/{{$org->id}}/edit" type="button" class="btn btn-secondary m-1">Edit</button> -->
                                            <a href="/organisasi/{{$org->id}}/edit">edit</a>
                                            <form action="/organisasi/{{$org->id}}" method="POST">
                                                @csrf
                                                @method('delete')
